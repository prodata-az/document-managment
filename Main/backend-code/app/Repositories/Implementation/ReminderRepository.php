...
class ReminderRepository extends BaseRepository implements ReminderRepositoryInterface
{
    ...
    public function getReminders($attributes)
    {
        $query = Reminders::select([
            ...
            'reminders.frequency', 'reminders.documentId', 'documents.name as documentName', 'documents.factory as documentFactory'
        ...
        } else if ($orderBy == 'documentFactory') {
            $query = $query->orderBy('documents.factory', $direction);
        }
